                ...
                <div class="card">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col">
                                <h3 class="mb-0">Editar nuevo producto</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <form action="{{ url('inventories/'.$inventory->id) }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input name="brand" type="text" class="form-control @if($errors->has('brand')) border-danger @endif" placeholder="LG, Apple, Alcatel, ASUS, Acer, DElL, HP etc... " value="{{old('brand', $inventory->name)}}"  autofocus>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group1">
                                            ...
                                            <input name="type" type="text" class="form-control @if($errors->has('type')) border-danger @endif" placeholder="Computadora, laptop, celular etc..." value="{{old('type', $inventory->type)}}">
                            ...
                            <div class="form-group">
                                ...
                                <input name="serial" type="text"  class="form-control @if($errors->has('serial')) border-danger @endif" placeholder="S/N - Serial" value="{{old('serial', $inventory->serial)}}">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="model" class="form-control @if($errors->has('model')) border-danger @endif" placeholder="Modelo del producto" value="{{old('model', $inventory->model)}}">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group1">
                                            ...
                                            <input type="text" name="color" class="form-control @if($errors->has('color')) border-danger @endif" placeholder="Color" value="{{old('serial', $inventory->serial)}}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="description" rows="3" placeholder="Escríbe aquí tu descripción del artículo...">{{old('description',$inventory->description)}}</textarea>
